...
{
    public class EmployeeEmailMustBeUniqueSpecificationTests : BaseTest
    {
        private readonly Mock<IReadRepository<Employee>> RepositoryMock;

        public EmployeeEmailMustBeUniqueSpecificationTests()
        {
        ...
        [Fact]
        public async Task IsSatisfiedByAsync_Should_Return_True_When_Email_Is_Unique()
        {
            // Arrange
            var employee = CreateEmployee("joao@biss.com.br");
            var specification = new EmployeeEmailMustBeUniqueSpecification(RepositoryMock.Object);
        ...
        [Fact]
        public async Task IsSatisfiedByAsync_Should_Return_True_When_Email_Is_Empty()
        {
            // Arrange
        ...
        [Fact]
        public async Task IsSatisfiedByAsync_Should_Return_True_When_Employee_Is_Null()
        {
            // Arrange
        ...
        [Fact]
        public async Task IsSatisfiedByAsync_Should_Throw_Exception_When_Email_Already_Exists()
        {
            // Arrange
            var employee = CreateEmployee("joao@biss.com.br");
            var existingEmployee = CreateEmployee("joao@biss.com.br");
            ...
            // Act & Assert
            await Assert.ThrowsAsync<EmployeeEmailAlreadyExistsException>(
                () => specification.IsSatisfiedByAsync(employee));
        }

        [Fact]
        public async Task IsSatisfiedByAsync_Should_Return_True_When_Email_Exists_But_Is_Excluded()
        {
            // Arrange
            ...
            var specification = new EmployeeEmailMustBeUniqueSpecification(RepositoryMock.Object, employeeId);
